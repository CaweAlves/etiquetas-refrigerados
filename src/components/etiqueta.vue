    ...
    <div class="min-h-screen bg-gray-100 flex flex-col">
        <header class="bg-white shadow">
            <div class="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
                <h1 class="text-2xl font-semibold text-gray-900">Sistema de Impressão de Etiquetas</h1>
            </div>
        </header>
            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div class="space-y-6">
                            <h2 class="text-lg leading-6 font-medium text-gray-900">Informações da Etiqueta</h2>
                            <form @submit.prevent="adicionarEtiqueta" class="space-y-4">
                                <div>
                                    <label for="produto" class="block text-sm font-medium text-gray-700">Nome do
                                        Produto</label>
                                ...
                                <div>
                                    ...
                                    <input type="number" id="quantidade" v-model="novaEtiqueta.quantidade" min="1"
                                        required
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                </div>
                                <div>
                        ...
                        <div class="space-y-6">
                            <h2 class="text-lg leading-6 font-medium text-gray-900">Visualização das Etiquetas</h2>
                            <div class="bg-gray-50 p-4 rounded-md overflow-auto max-h-96">
                                <div class="grid grid-cols-4 gap-1">
                                    <div v-for="(etiqueta, index) in etiquetas" :key="index"
                                        :class="['border-2 border-dashed border-gray-300 p-2 rounded-md print:rounded-none shadow-sm hover:shadow-md transition']"
